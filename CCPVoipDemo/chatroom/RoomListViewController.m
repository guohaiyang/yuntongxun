...
-(void)joinChatroomInRoomWithSelectRoom:(Chatroom*) selectRoom andPwd:(NSString*) pwd isJoin:(BOOL)isJoin
{
...
-(void)CustomeAlertViewDismiss:(CustomeAlertView *) alertView{
    ...
    else if (alertView.flag == 1)
    {
        ...
        {
            [self joinChatroomInRoomWithSelectRoom:self.curSelectRoom andPwd:self.myTextField.text isJoin:YES];
        }
    }
    [alertView release];
