...
- (void)createVideoConference:(id)sender
{
    ...
    if (nameTextField.text.length > 0 )
    {
        ...
        {
            [self.modelEngineVoip.VoipCallService startMultiVideoConferenceInAppId:self.modelEngineVoip.appID withName:nameTextField.text andSquare:5 andKeywords:@"" andPassword:@"" andIsAutoClose:isAutoClose andIsPresenter:NO andVoiceMod:1 andAutoDelete:bAutoDelete andIsAutoJoin:isAutoJoin ];
        }
    }
    else
    {
