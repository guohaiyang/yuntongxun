    ...
    switch (indexPath.section)
	{
        case 0:
        {
            ...
            else if (indexPath.row == 5)
            {
                ...
                cell.detailTextLabel.text = [NSString stringWithFormat:@"%d",fps];
            }
            else if (indexPath.row == 6)
            {
                ...
                if (cameraArr.count <= 0) {
                    ...
                    cell.detailTextLabel.text = [NSString stringWithFormat:@"width:%d;height:%d",capability.width, capability.height];
                }
            }
            [switchCtr release];
        }
        ...
        case 2:
        {
            ...
            if (indexPath.row == 0)
            {
                cell.textLabel.text = @"Codec_iLBC";
                cell.detailTextLabel.text = @"";
                NSInteger flag = [defaults integerForKey:Codec_iLBC_KEY];
                switchCtr.tag = TAG_SWITCH_Codec_iLBC;
                if (flag == 0)
                {
                    switchCtr.on = YES;
                }
            ...
            {
                cell.textLabel.text = @"Codec_PCMA";
                cell.detailTextLabel.text = @"";
                NSInteger flag = [defaults integerForKey:Codec_PCMA_KEY];
                switchCtr.tag = TAG_SWITCH_Codec_PCMA;
                if (flag == 0)
                {
                    switchCtr.on = YES;
                }
            ...
            {
                cell.textLabel.text = @"Codec_SILK8K";
                cell.detailTextLabel.text = @"";
                NSInteger flag = [defaults integerForKey:Codec_SILK8K_KEY];
                switchCtr.tag = TAG_SWITCH_Codec_SILK8K;
                if (flag == 0)
                {
                    switchCtr.on = YES;
                }
            ...
            {
                cell.textLabel.text = @"Codec_SILK12K";
                cell.detailTextLabel.text = @"";
                NSInteger flag = [defaults integerForKey:Codec_SILK12K_KEY];
                switchCtr.tag = TAG_SWITCH_Codec_SILK12K;
                if (flag == 0)
                {
                    switchCtr.on = YES;
                }
            ...
            {
                cell.textLabel.text = @"Codec_SILK16K";
                cell.detailTextLabel.text = @"";
                NSInteger flag = [defaults integerForKey:Codec_SILK16K_KEY];
                switchCtr.tag = TAG_SWITCH_Codec_SILK16K;
                if (flag == 0)
                {
                    switchCtr.on = YES;
                }
...
-(void)switchAction:(id)sender
{
    ...
    else if (switchctl.tag == TAG_SWITCH_Codec_PCMA)
    {
        if (switchctl.isOn)
        {
            [userDefaults setInteger:0 forKey:Codec_PCMA_KEY];
        }
        else
        {
            [userDefaults setInteger:1 forKey:Codec_PCMA_KEY];
        }
        [self.modelEngineVoip.VoipCallService setCodecEnabledWithCodec:Codec_PCMA andEnabled:switchctl.isOn];
