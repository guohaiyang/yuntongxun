...
@property (nonatomic) long long txBytes_sim; //在duration时间内，sim网络发送的总流量，单位字节；
@property (nonatomic) long long rxBytes_sim; //在duration时间内，sim网络接收的总流量，单位字节；
@property (nonatomic) long long txBytes_wifi; //在duration时间内，wifi网络发送的总流量，单位字节；
@property (nonatomic) long long rxBytes_wifi; //在duration时间内，wifi网络接收的总流量，单位字节；
@end
...
//离线消息数查询结果
@interface CheckVoipOfflineMsg : NSObject
@property (nonatomic, retain) NSString *sender;//发送者或群组id
@property (nonatomic, assign) NSInteger *count;//数量
@end

//离线消息查询结果
@interface OfflineMsg : NSObject
@property (nonatomic, retain) NSString  *timestamp;//数据更新时间单位:ms
@property (nonatomic, assign) NSInteger remainCount;//剩余离线消息个数
@property (nonatomic, retain) NSArray   *msgs;//离线消息
@end

//确认离线消息
@interface ConfirmOfflineMsg : NSObject
@property (nonatomic, retain) NSString *sender;//发送者
