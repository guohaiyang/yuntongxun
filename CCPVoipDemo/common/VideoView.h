...
@interface MultiVideoView : VideoView
{
    
}
@property (nonatomic, assign) CGRect originFrame;
@property (nonatomic, assign) BOOL isDisplayVideo;
@property (nonatomic, assign) BOOL isZoomBig;
@property (nonatomic, assign) CGFloat remoteRatioWidth;
@property (nonatomic, assign) CGFloat remoteRatioHehgth;
